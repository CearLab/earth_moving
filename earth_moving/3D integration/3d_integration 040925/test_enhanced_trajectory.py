...
def test_enhanced_trajectory_with_extension():
    ...
    print("   ESC = Exit")
    print("\n🔄 NEW: Post-Delivery Turn-Around:")
    print("   After target zone deliveries, rover will:")
    print("   1. Backup ~5cm to avoid disturbing objects") 
    print("   2. Rotate to face AWAY from target zone center (outward)")
    print("   3. STOP completely and wait for next assignment")
