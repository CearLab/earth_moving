...
class SimulationEventLogger:
    ...
    SUMMARY_FIELDS = (
        ...
        "predicted_delivered", "predicted_spillage", "impacted_cells_json",
    ...
    def __init__(self, log_dir: str | Path, pose_interval: float = 0.50):
        ...
        self.event("RUN_STARTED", 0.0, log_schema=2)
    ...
    def finish_task(self, agent_id: str, sim_time: float, outcome: str = "completed", **data: Any) -> None:
        with self._lock:
            ...
            row = {
                ...
                "predicted_delivered": active.get("predicted_delivered"),
                "predicted_spillage": active.get("predicted_spillage"),
                "impacted_cells_json": json.dumps(
                    _json_safe(active.get("impacted_cells", {})), separators=(",", ":")
                ),
