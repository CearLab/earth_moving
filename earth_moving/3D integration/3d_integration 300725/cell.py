...
class Cell:
    def __init__(self, x, y, num_objects, target_zone, grid_size):
        ...
        self.spline_points_target = []  # Store spline points for target path
        self.curvature_target = []  # Store curvature values for target path
        ...
        self.spline_points_highway = []  # Store spline points for highway path
        self.curvature_highway = []  # Store curvature values for highway path
