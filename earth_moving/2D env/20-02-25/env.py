...
class SimulationEnv:
    ...
    def calculate_potential_field(self):
        ...
        The cells are processed in order from closest to farthest from the target zone.
        """
        ...
        for cell in sorted_cells:
            ...
            best_path, max_objects, min_distance = a_star_search_target(cell)
            ...
            cell.total_distance_target = min_distance
    ...
    def calculate_path_to_highway(self):
        ...
        for cell in self.cells_with_objects:
            ...
            best_path, max_objects, min_distance = a_star_search_highway(cell)
            ...
            cell.total_distance_highway = min_distance
